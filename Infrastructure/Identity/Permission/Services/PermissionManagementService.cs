...
public class PermissionManagementService : IPermissionManagementService
{
    ...
    public PermissionManagementService(IStringLocalizationService localizationService, IActionLogService actionLogService, ILoggerService loggerService, IJsonSerializerService jsonSerializerService, IMapper mapper, IPaginationService paginationService, IPermissionRepository permissionRepository, IApplicationDbContext applicationDbContext)
    {
    ...
    public async Task<Result<PermissionResult>> UpdatePermissionAsync(Domain.Entities.Identity.Permission permission, CancellationToken cancellationToken = default(CancellationToken))
    {
        try
        {
            ...
            _permissionRepository.Update(perm);
