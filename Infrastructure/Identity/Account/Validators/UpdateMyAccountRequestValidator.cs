...
public class UpdateMyAccountRequestValidator: AbstractValidator<UpdateMyAccountRequest>
{
     public UpdateMyAccountRequestValidator(IUnitOfWork unitOfWork, IStringLocalizationService localizationService)
    {
