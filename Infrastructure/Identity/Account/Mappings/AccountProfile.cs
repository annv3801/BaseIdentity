...
namespace Infrastructure.Identity.Account.Mappings
{
    public class AccountProfile : Profile
    {
        public AccountProfile()
        {
            ...
            CreateMap<FacebookAccountData, LinkExternalAccountLoginRequest>()
                .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.FirstName, opt => opt.MapFrom(src => src.FirstName))
                .ForMember(dest => dest.LastName, opt => opt.MapFrom(src => src.LastName))
                .ForMember(d => d.Gender, opt => opt.MapFrom(src => src.Gender == "male" ))
                .ForMember(d => d.AvatarPhoto, opt => opt.MapFrom(src => src.Picture.Data.Url))
                ;
