...
public class UpdateFilmHandler : IUpdateFilmHandler
{
    private readonly IFilmManagementService _filmManagementService;
    private readonly ILoggerService _loggerService;
    private readonly IMapper _mapper;

    public UpdateFilmHandler(IFilmManagementService filmManagementService, ILoggerService loggerService, IMapper mapper)
    {
    ...
    public async Task<Result<FilmResult>> Handle(UpdateFilmCommand request, CancellationToken cancellationToken)
    {
        try
        {
        ...
        {
            _loggerService.LogCritical(e, nameof(UpdateFilmHandler));
            Console.WriteLine(e);
